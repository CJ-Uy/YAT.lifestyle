...
FIRST VIEWPORT: Fixed navigation above left-aligned copy and actions; a monumental pipette and suspended harbour drop own the right; collection previews touch the lower edge.
